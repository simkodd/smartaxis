...
function Happy() {
    ...
    return (
        <div ref={ref} className='bg-[#72A93E] h-fit mt-30'>

            

            <div className='text-white text-center'>
                <h1 className={`font-bold text-3xl lg:text-4xl tracking-wider text-shadow-lg pt-28 ${inView ? motionClassT : 'opacity-0'}`}>Happy Customers</h1>
                <div
                    ref={scrollRef}
                    onScroll={handleScroll}
                    
                    className='flex overflow-x-auto overflow-y-hidden scrollbar-hide snap-x snap-mandatory relative z-10'
                >
