        ...
        <div ref={ref} className='h-fit w-full mt-20'>
            ...
            <div className='relative'>
                <img
                    src="/photos/bg.svg"
                    alt=""
                    className='md:w-full sm:scale-100 scale-700 h-180 sm:h-auto' /> 
                <div className='absolute inset-0 flex sm:flex-row flex-col gap-y-20 text-2xl md:text-lg gap-x-6 lg:gap-x-15 items-center justify-center text-white font-bold tracking-wider'>
                    ...
                    <div className='text-center md:space-y-2 space-y-3'>
                        ...
                        <h1 className='lg:text-2xl sm:text-lg'>Years O<span className='border-t border-green pt-1 '>f Exp</span>erience</h1>
                    </div>
                    <div className='text-center md:space-y-2 space-y-3'>
                        <h1 className='lg:text-2xl'>{inView && (<CountUp key={inView} start={0} end={43} duration={3} delay={0} />)}+</h1>
                        <h1 className='lg:text-2xl sm:text-lg'>Techno<span className='border-t border-green pt-1'>logy </span>Experts</h1>
                    </div>

                    <div className='text-center md:space-y-2 space-y-3'>
                        <h1 className='lg:text-2xl'>{inView && (<CountUp key={inView} start={0} end={1533} duration={3} delay={0} />)}+</h1>
                        <h1 className='lg:text-2xl sm:text-lg'>Wholes<span className='border-t border-green pt-1'>ale P</span>artners</h1>
                    </div>
                    <div className='text-center md:space-y-2 space-y-3'>
                        <h1 className='lg:text-2xl'>{inView && (<CountUp key={inView} start={0} end={3892} duration={3} delay={0} />)}+</h1>
                        <h1 className='lg:text-2xl sm:text-lg'>Satisfi<span className='border-t border-green pt-1'>ed Cu</span>stomers</h1>
                    </div>
