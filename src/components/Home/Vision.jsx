...
function Vision() {
    ...
    return (
        <div ref={ref} className='h-fit '>
            <div className={`text-center mt-10 ${inView ? motionClassT : 'opacity-0'}`}>
            ...
            <div className='flex flex-wrap gap-y-2 gap-x-2 items-center justify-center pt-10'>
                <div className={`flex flex-col w-38 lg:w-60 ${inView ? motionClassR : 'opacity-0'}`}>
                    <video
                        src="/photos/101.mp4"
                        alt="laptop video"
                ...
                <div className={`flex flex-col w-38 lg:w-60 md:h-40 sm:justify-center ${inView ? motionClassR : 'opacity-0'}`}>
                    <img
                        src="/photos/lap2.jpg"
                        alt="photo1"
                        className=' w-full border-2 border-white rounded-xl shadow-2xl shadow-blue  ' />
                </div>
                <div className={`flex flex-col w-38 lg:w-60 ${inView ? 'motion-preset-fade motion-duration-2000' : 'opacity-0'}`}>
                    <video
                        src="/photos/10.mp4"
                        alt="laptop video"
                ...
                <div className={`flex flex-col w-38 lg:w-60 md:h-40 sm:justify-center ${inView ? motionClassL : 'opacity-0'}`}>
                    <img
                        src="/photos/lap4.jpg"
                        alt="photo1"
                        className=' w-full border-2 border-white rounded-xl shadow-2xl shadow-blue  ' />
                </div>
                <div className={`flex flex-col w-38 lg:w-60 ${inView ? motionClassL : 'opacity-0'}`}>
                   <video
                        src="/photos/102.mp4"
                        alt="laptop video"
