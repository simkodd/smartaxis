...
function Why() {
    ...
    return (
        <div ref={ref} className='h-fit md:flex w-full px-5'>
            ...
            <div className={`w-1/2 ${inView ? motionClassL : 'opacity-0'}`}>
                <p className='text-green font-semibold lg:text-3xl text-2xl/9 md:mt-0 mt-12 w-full'> <span className='border-b border-blue pb-1 '> Wh</span>y Choose Us</p>
