...
function Map() {
    ...
    return (
        <div className='h-fit text-center'>
            <div>
                <h1 ref={ref} className={`text-green text-3xl tracking-wider text-shadow-lg mt-20 ${inView ? motionClassT : 'opacity-0'}`}>Let’s Work Together! </h1>
            ...
            <div className="w-full md:h-70 h-100">
                <iframe
