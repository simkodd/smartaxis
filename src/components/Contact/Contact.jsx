    ...
    <div className='h-screen'>
      <div ref={ref} className='md:flex w-full'>
        <div className={`md:w-1/3 m-10 mt-20 ${inView ? motionClassR : 'opacity-0'}`}>
          ...
          <div className='flex flex-col gap-y-10 mt-10 text-blue font-medium'>
            <div className='flex'>
              ...
              <a href="tel:+971585026002" className='ml-2 lg:text-lg border-b border-blue active:scale-97 duration-300'>+971 58 502 6002</a>
            </div>
            <div className='flex'>
              <img src="/photos/mail.svg" alt="call" className='size-5 lg:size-8' />
              <a href="mailto:ContactUs@SmartAxis.net?subject=İletişim&body=Hello," className=' ml-2 lg:text-lg border-b border-blue active:scale-97 duration-300'>ContactUs@SmartAxis.net</a>
            </div>
            <div className='flex'>
        ...
        <div ref={ref}  className={`md:w-2/3 m-8 mt-20 h-110 lg:h-140 md:h-auto ${inView ? motionClassL : 'opacity-0'}`}>
          ...
          height="450" 
          className='border-white w-full border-2 rounded-xl mt-4 shadow-[0_0_15px_2px_rgba(2,57,122,0.8)]' 
          allowFullScreen
          loading="lazy" 
