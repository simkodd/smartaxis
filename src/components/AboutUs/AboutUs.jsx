 ...
 const { ref, inView } = useInView({
  ...
  return (
    <div className='h-fit'>
      ...
      <div className='absolute inset-0 md:mt-20 mt-25 text-center text-white motion-translate-x-in-[0%] motion-translate-y-in-[-100%] motion-duration-1000 motion-ease-spring-bouncier'>
        <h1 className='font-extrabold md:text-4xl text-3xl tracking-wider '>Welcome To <span className='text-green'>Smart Axis</span></h1>
