 ...
 const { ref, inView } = useInView({
  ...
  return (
    <div className='h-fit'>
      ...
      <div ref={ref} className='flex w-full items-start mt-40 md:mt-0'>
        <div className ={`w-1/2 md:p-12 p-4 ${inView ? motionClassR : 'opacity-0'}`}>
          <img src="/photos/shake.jpg" alt="" className='' />
          <div className='font-semibold mt-4'>
            <p className='text-green md:text-xl text-base/8 lg:text-2xl md:tracking-wider'><span className='border-blue border-b-1 pb-2'>Vis</span>ion, Mission & Values</p>
        ...
        <div className={`w-1/2 md:p-12 p-4 ${inView ? motionClassL : 'opacity-0'}`}>
          <img src="/photos/office.jpg" alt="" />
          <div className='font-semibold mt-4'>
            <p className='text-green md:text-xl pb-8 md:pb-0 lg:text-2xl md:tracking-wider'><span className='border-blue border-b-1 pb-2'>His</span>tory</p>
