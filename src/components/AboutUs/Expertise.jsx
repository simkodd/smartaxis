        ...
        <div className='h-fit flex w-full'>
            ...
            <div ref={ref} className={`w-1/2 bg-[#72A93E] size-104 ${inView ? motionClassL :'opacity-0'}`}>
                <div className='text-white md:p-10 p-7'>
                    <p className='font-extrabold md:text-2xl text-xl md:tracking-wider'><span className='border-blue border-b-1 pb-2'>Ou</span>r Expertise</p>
                    <p className='opacity-50 font-semibold text-[10px]/3 mt-5'>We redefine excellence in refurbished technology. By meticulously controlling every step, from sourcing to support, we deliver trusted value to all clients. Our expertise is built on four core pillars:</p>
                </div>
